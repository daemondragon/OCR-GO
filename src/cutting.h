...
// input : start of the line , width of the matrix , treshold to define when a line is black
char is_black_line(double *start, int width, int threshold);

// return 1 if the column is black 
// input : start of band , end of the band, width of the matrix , treshold to define when a column is black
char is_black_column(double *start, double *end, int width, int threshold);

// do the vertical cutting filling the list of words and count the number of word/char and their width
